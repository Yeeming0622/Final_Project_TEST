...
public class SnakePanelView extends View {
  ...
  private void moveSnake(int snakeDirection) {
    switch (snakeDirection) {
      case GameType.LEFT:
        if (mSnakeHeader.getX() - 1 < 0) {//邊界判斷:碰到最右邊會從左邊出現
  ...
  public static class Data {
    ...
    public void sends(){
      String gg = Integer.toString(score);
      mListener.send(gg);
    }
  }
}
